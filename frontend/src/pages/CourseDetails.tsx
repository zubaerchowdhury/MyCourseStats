...
function CourseDetails() {
  ...
  // Mock enrollment probability (this would come from backend calculations)
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-white rounded-lg shadow-lg overflow-hidden">
        <div className="p-8">
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-base font-medium text-gray-900">Undergraduate</p>
                </div>
              </div>
            </div>
          </div>
              ...
              {timeSlots.map((slot) => (
                ...
                >
                  <div className="flex items-center">
                    ...
                    <span className={`${!slot.available ? 'text-gray-400' : 'text-gray-700'}`}>
                      {slot.time}
                    </span>
                  </div>
                  {selectedTimeSlot === slot.time && (
            ...
            {selectedTimeSlot && (
              <div className="mt-6 flex justify-end">
                <button 
                  ...
                  onClick={() => alert(`Time slot selected: ${selectedTimeSlot}`)}
                >
          ...
          <div className="mt-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Enrollment Probability Score</h2>
