      ...
      try {
        ...
        const transformedData: CourseSection[] = data.map(
          (container: CourseContainer) => {
            ...
            const transformedCourseSection: CourseSection = {
              ...courseSection,
              timeStart: new Date(courseSection.timeStart.toString()),
              timeEnd: new Date(courseSection.timeEnd.toString()),
              startDate: new Date(courseSection.startDate.toString()),
              endDate: new Date(courseSection.endDate.toString()),
            };
            return transformedCourseSection;
          }
        );
